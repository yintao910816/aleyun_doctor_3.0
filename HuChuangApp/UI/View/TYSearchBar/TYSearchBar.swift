...
struct TYSearchBarConfig {
    ...
    /// 患者消息列表
    static public func createConsultList() ->TYSearchBarConfig {
        return TYSearchBarConfig.init(isInNav: false, searchPlaceholder: "请输入您要查找的患者姓名", tfBackGroundColor: RGB(243, 243, 243))
    }
    
    /// 搜索患者
    static public func createPatientSearch() ->TYSearchBarConfig {
        return TYSearchBarConfig.init(isInNav: false, searchPlaceholder: "请输入您要查找的患者姓名", rightTitle: "取消", rightTitleColor: RGB(168, 169, 170), tfBackGroundColor: RGB(243, 243, 243))
    }
