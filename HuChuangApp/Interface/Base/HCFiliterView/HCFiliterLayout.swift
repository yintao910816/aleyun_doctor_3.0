...
protocol HCFiliterLayoutDelegate: class {
    /// 单个cell的大小
...
class HCFiliterLayout: UICollectionViewFlowLayout {

    private var lastFrame: CGRect = .zero
    private var attributeArray: [UICollectionViewLayoutAttributes] = []
    
    public weak var layoutDelegate: HCFiliterLayoutDelegate?
