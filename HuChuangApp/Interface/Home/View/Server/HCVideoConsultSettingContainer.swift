//
//  HCVideoConsultSettingContainer.swift
//  HuChuangApp
//
...
class HCVideoConsultSettingContainer: UIView {
    ...
    override init(frame: CGRect) {
        ...
        collectionView.register(HCVideoConsultDaySettingCell.self,
                                forCellWithReuseIdentifier: HCVideoConsultDaySettingCell_identifier)
...
extension HCVideoConsultSettingContainer: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section == 2 {
            let model = datasource[indexPath.section][indexPath.row] as! HCVideoDaySettingModel
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: HCVideoConsultDaySettingCell_identifier, for: indexPath) as! HCVideoConsultDaySettingCell
            cell.model = model
            return cell
        }else {
